function getRenderedDays({ monthIndex, year }) {
    ...
    // console.log({ monthIndex, year, firstDayOfMonth, firstWeekDayOfMonth,
    //     lastDayOfMonth, lastWeekDayOfMonth,
    //     startDayShift, endDayShift,
    //     firstRenderedDay, lastRenderedDay });

    // console.log( firstDayOfMonth < lastRenderedDay );
...
const calendar = {
    ...
    $title: document.querySelector('.header-right-title span'),
